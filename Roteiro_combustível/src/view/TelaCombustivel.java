...
public class TelaCombustivel extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaCombustivel frame = new TelaCombustivel();
	...
	public TelaCombustivel() {
		...
		JRadioButton rdbtAVista = new JRadioButton("Ã€ vista");
		...
		JRadioButton rdbtnAPrazo = new JRadioButton("Ã€ prazo");
